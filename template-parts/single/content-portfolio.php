                ...
                <?php } else { ?>
                    ...
                    <?php if ($houses_floor) { ?>
                        <div class="description__item">
                            ...
                            <div class="description__data"><span><?php echo $houses_floor; ?></span></div>
                        </div>
                    <?php } ?>

                    <?php if ($houses_bedroom) { ?>
                        <div class="description__item">
                            <div class="description__label"><span>Кол-во спален:</span></div>
                            <div class="description__data"><span><?php echo $houses_bedroom; ?></span></div>
                        </div>
                    <?php } ?>
