...
<section class="request section" id="request">
    <div class="container_center container_center_right">
        <div class="request__title"><span>Оставьте заявку — вышлем вам образец агентского договора</span></div>
        <div class="request__subtitle"><span>и обсудим партнерство</span></div>
    </div>
        ...
        <div class="request__form">
            <div class="form__wrap">
                <form class="form form_grid" action="<?php echo get_template_directory_uri() . '/send.php'; ?>">
                    ...
                    <input type="hidden" name="subject" value="Оставьте заявку — вышлем вам образец агентского договора" />
                    ...
                    <div class="form__row form__row_38">
                        ...
                        <button class="btn btn_didisabled_js" type="submit"><span>Получить образец
                                договора</span><span>и обсудить сотрудничество </span></button>
                    </div>
