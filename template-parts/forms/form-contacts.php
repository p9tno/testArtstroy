<div class="contacts__form bg">
    <div class="contacts__form-title"><span>Форма обратной связи</span></div>
    <div class="contacts__form-subtitle"><span>Оставьте заявку, позвоним в течение 10 минут</span></div>
    <form class="form" action="<?php echo get_template_directory_uri() . '/send.php'; ?>">

        <input type="hidden" name="subject" value="Форма обратной связи (контакты)." />
