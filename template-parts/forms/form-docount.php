<div class="docount__form">
    <div class="docount__caption"><span>Рассчитаем<br> смету бесплатно</span><small>Пришлите проект или
            тех.задание, мы сформируем предвариательное предложение для вас: сроки и порядок работ, смета и
            условия </small></div>
    <div class="form__wrap">
        <form class="form form_grid-col4" action="<?php echo get_template_directory_uri() . '/send.php'; ?>">

            <input type="hidden" name="subject" value="Рассчитаем смету бесплатно" />
            ...
            <div class="form__row form__row_31">
                ...
                <button class="btn btn_didisabled_js" type="submit"><span>Рассчитать смету</span></button>
            </div>
