<!-- begin advantage-->
<section class="advantage section orange" id="advantage">
    <div class="container_center container_center_sm">
        <div class="advantage__wrap">
            <div class="advantage__caption">
                ...
                <?php if (get_field('advantage_title')) { ?>
                    <h2 class="section__title"><span><?php the_field('advantage_title'); ?></span></h2>
                <?php } ?>

                <?php if (get_field('advantage_subtitle')) { ?>
                    <div class="section__subtitle">
                        <?php the_field('advantage_subtitle'); ?>
                    </div>
                <?php } ?>
            </div>

            <?php 
            $rows = get_field('advantage_list');
            if( $rows ) { ?>
