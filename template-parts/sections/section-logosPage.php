...
$rows = get_field('logos_page_list');
if( $rows ) { ?>
  <!-- begin logos-->
  <section class="logos section" id="logos">
      <div class="container_center container_center_sm">

            <div class="logos__caption">
                <?php if (get_field('logos_page_title')) { ?>
                    <h2 class="section__title" data-aos="fade-up"><span><?php the_field('logos_page_title'); ?></span></h2>
                <?php } ?>
                <?php if (get_field('logos_page_label')) { ?>
                    <div class="logos__label"><?php the_field('logos_page_label'); ?></div>
                <?php } ?>
            </div>
