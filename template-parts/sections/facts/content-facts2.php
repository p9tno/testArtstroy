<?php
$class_dark = '';
if (get_field('facts_select_2') == 'dark') {
    ...
    <div class="container_center">
        <div class="facts__content facts__content_center">
            ...
            <div class="facts__caption">
                <?php if (get_field('facts_sec_subtitle_top_2')) { ?>
                    <div class="section__subtitle"><span><?php the_field('facts_sec_subtitle_top_2'); ?></span></div>
                <?php } ?>
                <?php if (get_field('facts_sec_title_2')) { ?>
                    <h2 class="section__title" data-aos="fade-up"><span><?php the_field('facts_sec_title_2'); ?></span></h2>
                <?php } ?>
                <?php if (get_field('facts_sec_subtitle_bottom_2')) { ?>
                    <div class="section__subtitle"><span><?php the_field('facts_sec_subtitle_bottom_2'); ?></span></div>
                <?php } ?>
            </div>

            <?php 
            $rows = get_field('facts_list_2');
            if( $rows ) { ?>
