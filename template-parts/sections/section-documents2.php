<!-- begin documents2 certificate-->
<section class="certificate section" id="documents2">
    <div class="container_center container_center_sm">
        <div class="certificate__content">
            <div class="certificate__left">
                <div class="certificate__caption">
                    <?php if (get_field('documents_title_2')) { ?>
                        <h2 class="section__title" data-aos="fade-up"><span><?php the_field('documents_title_2'); ?></span></h2>
                    <?php } ?>
                    <?php if (get_field('documents_description_2')) { ?>
                        <div class="certificate__description"><?php the_field('documents_description_2'); ?></div>
                    <?php } ?>
                </div>
            ...
            $rows = get_field('documents_list_2');
            if( $rows ) { ?>
