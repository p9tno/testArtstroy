...
?>
<!-- begin team teamPage-->
<section class="team section" id="teamPage">
                    ...
                    <div class="swiper-slide teamPreview__slide">
                      <div class="team__top">
                          <div class="team__left">
                            ...
                            <?php if (get_field('teamPage_title')) { ?>
                              <h2 class="section__title" data-aos="fade-up"><span><?php the_field('teamPage_title'); ?></span></h2>
                            <?php } ?>
  
                            <?php if (get_field('teamPage_subtitle')) { ?>
                              <div class="team__subtitle"><span><?php the_field('teamPage_subtitle'); ?></span></div>
                            <?php } ?>
