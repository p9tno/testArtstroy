<!-- Begin Modal application-->
<div class="modal fade application" id="application">
    <div class="modal-dialog">
        <div class="modal-content bg"><a class="modal-close" href="#" data-dismiss="modal"></a>
            <div class="modal-header">
                <div class="modal-title"> <span>Быстро<br> оставить заявку</span><small>Введите номер — позвоним вам<br>
                        в течение 10 минут в рабочее время</small></div>
            </div>
            <div class="modal-body">
                <div class="modal-form">
                    <form class="form" action="<?php echo get_template_directory_uri() . '/send.php'; ?>">

                        <input type="hidden" name="subject" value="Быстро оставить заявку (модальное окно)" />
